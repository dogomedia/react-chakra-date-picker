import { BoxProps, ButtonProps, CloseButtonProps, FlexProps, IconButtonProps, IconProps, InputAddonProps, InputGroupProps, InputProps, SimpleGridProps, StackDividerProps, StackProps } from '@chakra-ui/react';
export declare type StateProp<T extends any> = {
    base: T;
    active?: T;
};
...
export interface DatepickerStyles extends ActionButtonStyles, CloseButtonStyles, DatepickerComponentStyles, DayStyles, InputComponentStyles, MonthStyles, ResetDatesButtonStyles, SelectDateStyles, DateRangeInputStyles {
}
