...
var StylesContext = /*#__PURE__*/React.createContext({
...
function useStyleProps(inlineStyles) {
  var _useContext = React.useContext(StylesContext),
...
var ActionButton = function ActionButton(_ref) {
  ...
  var IconComponent = icons.ChevronLeftIcon;
  ...
  if (direction === 'up') {
    IconComponent = icons.ChevronUpIcon;
  } else if (direction === 'right') {
    IconComponent = icons.ChevronRightIcon;
  } else if (direction === 'down') {
    IconComponent = icons.ChevronDownIcon;
  } else if (direction === 'left') {
    IconComponent = icons.ChevronLeftIcon;
  }

  return React__default.createElement(react.IconButton, Object.assign({
    "aria-label": "Arrow " + direction,
    icon: React__default.createElement(IconComponent, null)
...
var CloseButton = function CloseButton(props) {
  ...
  return React__default.createElement(react.CloseButton, Object.assign({}, styleProps.closeButton, props));
};
...
var defaultFormatters = {
  monthLabelFormat: hooks.monthLabelFormat,
  weekdayLabelFormat: hooks.weekdayLabelFormat,
...
var DatepickerContext = /*#__PURE__*/React__default.createContext(datepickerContextDefaultValue);
...
function Day(_ref3) {
  ...
  var styleProps = useStyleProps({
    day: {
      base: {
        ...
        fontSize: ['sm', 'md'],
        border: '2px solid',
        textColor: react.useColorModeValue('gray.900', 'white'),
        borderRadius: '100%',
      ...
      normal: {
        _hover: {
          borderColor: react.useColorModeValue('black', 'white')
        }
      },
      rangeHover: {
        _hover: {
      ...
      firstOrLast: {
        textColor: react.useColorModeValue('white', 'black'),
        background: react.useColorModeValue('black', 'white'),
        _hover: {
          textColor: react.useColorModeValue('white', 'black'),
          background: react.useColorModeValue('black', 'white')
        }
    ...
    dayContainer: {
      ...
      normal: {},
      rangeHover: {
        background: react.useColorModeValue('gray.100', 'gray.500'),
        _hover: {
          borderRightRadius: '100%'
        }
      },
  ...
  var isFirst = hooks.isStartDate(date, startDate);
  var isLast = hooks.isEndDate(date, endDate);
  ...
  return React__default.createElement(react.Box, Object.assign({}, containerStyle), React__default.createElement(react.Button, Object.assign({}, buttonStyle, {
    variant: "unstyled",
    onClick: onClick,
    onKeyDown: onKeyDown,
...
var Input = /*#__PURE__*/React.forwardRef(function (props, inputRef) {
  var _props$dateFormat = props.dateFormat,
      ...
      iconComponent = _props$iconComponent === void 0 ? icons.CalendarIcon : _props$iconComponent,
      id = props.id,
  ...
  function handleOnChange(e) {
    ...
    ref.current = setTimeout(function () {
      onClick();
      var parsedDate = hooks.parseDate(dateValue, dateFormat, new Date());
  ...
  return React__default.createElement(react.InputGroup, Object.assign({}, getStateStyle(styleProps.inputComponentInputGroup, isActive), {
    htmlFor: id
  }), showCalendarIcon && React__default.createElement(react.InputLeftAddon, Object.assign({}, getStateStyle(styleProps.inputComponentInputAddon, isActive)), React__default.createElement(react.Icon, Object.assign({
    as: iconComponent
  }, getStateStyle(styleProps.inputComponentIcon, isActive)))), React__default.createElement(react.Input, Object.assign({}, inputProps, getStateStyle(styleProps.inputComponentInput, isActive), {
    ref: inputRef,
    id: id,
    name: name,
...
var Month = function Month(_ref) {
  ...
  return React__default.createElement(react.Box, Object.assign({}, styleProps.monthContainer), React__default.createElement(react.Flex, Object.assign({}, styleProps.monthMonthLabel), React__default.createElement(react.Text, null, monthLabel)), React__default.createElement(react.SimpleGrid, {
    columns: 7
  }, weekdayLabels.map(function (weekdayLabel) {
    return React__default.createElement(react.Flex, Object.assign({
      key: weekdayLabel
    }, styleProps.monthWeekdayLabel), React__default.createElement(react.Text, null, weekdayLabel));
  })), React__default.createElement(react.SimpleGrid, Object.assign({}, styleProps.monthDayGrid, {
    columns: 7
  }), days.map(function (day, index) {
    return typeof day === 'object' ? React__default.createElement(Day, {
      date: day.date,
...
function ResetDatesButton(_ref) {
  ...
  return React__default.createElement(react.Button, Object.assign({
    icon: React__default.createElement(icons.RepeatIcon, null),
    tabIndex: -1,
...
var SelectedDate = function SelectedDate(_ref) {
  ...
  return React__default.createElement(react.Stack, Object.assign({}, getStateStyle(styleProps.selectDateContainer, isFocused)), React__default.createElement(react.Text, Object.assign({}, getStateStyle(styleProps.selectDateText, isFocused)), phrases.datepickerStartDateLabel), React__default.createElement(react.Text, Object.assign({}, getStateStyle(styleProps.selectDateDateText, isFocused)), hooks.getInputValue(date, displayFormat, phrases.datepickerStartDatePlaceholder)));
};

var Datepicker = /*#__PURE__*/React__default.forwardRef(function (props, ref) {
  ...
  var isMobile = react.useBreakpointValue({
    base: true,
    md: false
  });
  ...
  var styleProps = useStyleProps({
    datepickerContainer: {
      background: react.useColorModeValue('white', 'gray.700'),
      borderRadius: 'md',
      position: 'relative',
      width: 'fit-content',
      shadow: 'md',
  ...
  return React__default.createElement(StylesProvider, {
    styles: customStyles,
    overwriteDefaultStyles: overwriteDefaultStyles
  }, React__default.createElement(DatepickerProvider, {
  ...
  }, React__default.createElement(react.Box, Object.assign({}, styleProps.datepickerContainer), showClose && React__default.createElement(CloseButton, {
    onClick: onClose
  }), showSelectedDates && React__default.createElement(react.Box, {
    mb: 6
  }, React__default.createElement(react.HStack, {
    "data-testid": "SelectedDatesGrid"
  }, React__default.createElement(SelectedDate, {
    date: startDate,
    isFocused: focusedInput === hooks.START_DATE
  }), React__default.createElement(react.Flex, {
    justifyContent: "center",
    alignItems: "center"
  }, React__default.createElement(icons.ArrowForwardIcon, Object.assign({}, styleProps.arrowIcon))), React__default.createElement(SelectedDate, {
    date: endDate,
    isFocused: focusedInput === hooks.END_DATE
  }))), React__default.createElement(react.Box, {
    position: "relative"
  }, React__default.createElement(react.Stack, Object.assign({
  ...
  })), React__default.createElement(react.Flex, Object.assign({}, styleProps.datepickerFooter), React__default.createElement(react.HStack, Object.assign({}, styleProps.buttonsWrapper), React__default.createElement(ActionButton, {
  ...
  })), showResetDates && React__default.createElement(ResetDatesButton, {
    onResetDates: dp.onResetDates,
...
var DateRangeInput = function DateRangeInput(props) {
  ...
  var _useState = React.useState(startDateProp),
      startDate = _useState[0],
      setStartDate = _useState[1];

  var _useState2 = React.useState(endDateProp),
      endDate = _useState2[0],
      setEndDate = _useState2[1];

  var _useState3 = React.useState(focusedInputProp),
  ...
  return React__default.createElement(StylesProvider, {
    ...
    divider: showDivider ? React__default.createElement(react.StackDivider, Object.assign({}, styleProps.dateRangeInputDivider)) : undefined
    ...
    isActive: focusedInput === hooks.START_DATE,
    onChange: handleInputChange,
    onClick: function onClick() {
      return handleOnFocusChange(hooks.START_DATE);
    },
    value: hooks.getInputValue(startDate, displayFormat, ''),
    ...
    dateFormat: displayFormat,
    disableAccessibility: focusedInput === hooks.START_DATE,
    isActive: focusedInput === hooks.END_DATE,
    onChange: handleInputChange,
    onClick: function onClick() {
      return handleOnFocusChange(!startDate ? hooks.START_DATE : hooks.END_DATE);
    },
    value: hooks.getInputValue(endDate, displayFormat, ''),
    allowEditableInputs: allowEditableInputs
  })), React__default.createElement(react.Box, {
    position: "absolute",
    top: placement === 'top' ? undefined : vertical ? '100px' : '45px',
    bottom: placement === 'bottom' ? undefined : vertical ? '100px' : '45px'
  }, focusedInput !== null && React__default.createElement(Datepicker, {
    ref: datepickerRef,
    startDate: startDate,
    endDate: endDate,
    focusedInput: focusedInput,
...
var DateSingleInput = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var _useState = React.useState(value ? new Date(value) : dateProp),
      date = _useState[0],
      setDate = _useState[1];

  var _useState2 = React.useState(showDatepickerProp),
  ...
  return React__default.createElement(StylesProvider, {
    ...
    value: hooks.getInputValue(date, displayFormat, ''),
  ...
  }, showDatepicker && React__default.createElement(Datepicker, {
    changeActiveMonthOnSelect: changeActiveMonthOnSelect,
    dayLabelFormat: dayLabelFormat,
    displayFormat: displayFormat,
    endDate: date,
    ...
    firstDayOfWeek: firstDayOfWeek,
    focusedInput: showDatepicker ? hooks.START_DATE : null,
    initialVisibleMonth: initialVisibleMonth,
    isDateBlocked: isDateBlocked,
    maxBookingDate: maxBookingDate,
    minBookingDate: minBookingDate,
...
Object.defineProperty(exports, 'monthLabelFormatFn', {
  enumerable: true,
  get: function () {
    return hooks.monthLabelFormat;
  }
});
Object.defineProperty(exports, 'weekdayLabelFormatFn', {
  enumerable: true,
  get: function () {
    return hooks.weekdayLabelFormat;
  }
});
...
//# sourceMappingURL=react-chakra-ui-datepicker.cjs.development.js.map
